                    ...
                    >
                        ...
                        <div className="flex flex-col gap-4 h-full pl-20 pr-20">
                            <div className="w-fit flex h-full justify-start flex-col gap-4">
                                ...
                                >
                                    Welcome to my portfolio, Software engineer
                                    with a passion for developing innovative
                                    solutions to complex problems. With
                                    expertise in full-stack development, cloud
                                    technologies, and agile methodologies, I
                                    create efficient, scalable, and
                                    user-friendly applications. My experience
                                    spans across various projects, from building
                                    robust e-commerce platforms to designing
                                    real-time chat applications and developing
